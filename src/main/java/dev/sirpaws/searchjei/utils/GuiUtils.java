...
public class GuiUtils {
    ...
    public static void initUtil() {
        try {
            ...
            try {
                ...
                SearchJEI.LOGGER.error("Failed to load gui coordinate fields for reflection");
                f.printStackTrace();
                fieldTop = null;
                fieldLeft = null;
            }
    ...
    public static int getGuiTop(AbstractContainerScreen<?> container) {
        ...
        try {
            ...
            SearchJEI.LOGGER.error("Failed to access topPos field");
            e.printStackTrace();
        }
        return 0;
    }
    ...
    public static int getGuiLeft(AbstractContainerScreen<?> container) {
        ...
        try {
            ...
            SearchJEI.LOGGER.error("Failed to access leftPos field");
            e.printStackTrace();
        }
        return 0;
    }
